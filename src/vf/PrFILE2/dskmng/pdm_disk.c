...
pf_s32 VFipdm_disk_physical_read(PDM_DISK* p_disk, unsigned char* buf, pf_u32 psector, pf_u32 num_sector, pf_u16 bps, pf_u32* p_num_success) {
    pf_s32 err;
    pf_u32 block;
    pf_u32 num_block;
    pf_u32 tmp_sector;
...
pf_s32 VFipdm_disk_format(PDM_DISK* p_disk, const unsigned char* param) {
    pf_s32 err;
    PDM_DISK* lp_disk;
