...
#define OSSleepSeconds(s) OSSleepTicks(OSSecondsToTicks((s64)s))
#define OSSleepMilliseconds(ms) OSSleepTicks(OSMillisecondsToTicks((s64)ms))
#define OSSleepMicroseconds(us) OSSleepTicks(OSMicrosecondsToTicks((s64)us))
#define OSSleepNanoseconds(ns) OSSleepTicks(OSNanosecondsToTicks((s64)ns))
