...
long VFiPFDRV_lread(struct PF_VOLUME * p_vol /* r31 */, unsigned char * buf /* r1+0x8 */, unsigned long sector /* r1+0xC */, unsigned long num_sectors /* r1+0x10 */, unsigned long * p_num_success /* r1+0x14 */);
long VFiPFDRV_lwrite(struct PF_VOLUME * p_vol /* r31 */, const unsigned char * buf /* r1+0x8 */, unsigned long sector /* r1+0xC */, unsigned long num_sectors /* r1+0x10 */, unsigned long * p_num_success /* r1+0x14 */);
