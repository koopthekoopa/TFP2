...
int dCommon_IsPrfFile(void* buff);
...
s32 dCommon_FlushFromVol(PF_VOLUME* vol, int setLastDeviceError);
s32 dCommon_FlushFromHandleIdx(int handle_idx, int setLastDeviceError);
