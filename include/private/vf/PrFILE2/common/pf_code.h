...
#define PF_CODE_MODE_0 0
#define PF_CODE_MODE_ASCII 1
#define PF_CODE_MODE_UNICODE 2
...
#define C_TO_WC(x0, x1) ((pf_u16)(((pf_u8)(x0) << 8) + (pf_u8)(x1)))
#define C_TO_WC_ARR(x, i) C_TO_WC(x[i], x[i + 1])
