...
void VFiPFCACHE_SetCache(struct PF_VOLUME * p_vol /* r3 */, struct PF_CACHE_PAGE * p_cache_page /* r4 */, unsigned char (* p_cache_buf)[512] /* r5 */, unsigned short num_fat_pages /* r6 */, unsigned short num_data_pages /* r7 */);
...
long VFiPFCACHE_ReadDataPage(struct PF_VOLUME * p_vol /* r30 */, unsigned long sector /* r1+0x8 */, struct PF_CACHE_PAGE * * pp_page /* r1+0xC */, unsigned long set_sig /* r1+0x10 */);
long VFiPFCACHE_ReadDataPageAndFlushIfNeeded(struct PF_VOLUME * p_vol /* r30 */, unsigned long sector /* r1+0x8 */, struct PF_CACHE_PAGE * * pp_page /* r1+0xC */, unsigned long set_sig /* r1+0x10 */);
long VFiPFCACHE_ReadDataNumSector(struct PF_VOLUME * p_vol /* r30 */, unsigned char * p_buf /* r1+0x8 */, unsigned long sector /* r29 */, unsigned long num_sector /* r1+0xC */, unsigned long * p_num_success /* r1+0x10 */);
...
long VFiPFCACHE_WriteFATSectorAndFreeIfNeeded(struct PF_VOLUME * p_vol /* r30 */, const unsigned char * p_buf /* r1+0x8 */, unsigned long sector /* r29 */);
long VFiPFCACHE_WriteDataNumSectorAndFreeIfNeeded(struct PF_VOLUME * p_vol /* r30 */, const unsigned char * p_buf /* r1+0x8 */, unsigned long sector /* r29 */, unsigned long num_sector /* r1+0xC */, unsigned long * p_num_success /* r1+0x10 */);
