...
long VFiPFENT_ITER_FindEntry(struct PF_ENT_ITER * p_iter /* r1+0x8 */, struct PF_DIR_ENT * p_ent /* r26 */, struct PF_STR * p_pattern /* r29 */, unsigned char attr_required /* r27 */, unsigned char attr_unwanted /* r28 */, unsigned long * p_is_found /* r30 */, unsigned long is_skip /* r1+0xC */);
long VFiPFENT_ITER_GetEntryOfPath(struct PF_ENT_ITER * p_iter /* r1+0x8 */, struct PF_DIR_ENT * p_ent /* r1+0xC */, struct PF_VOLUME * p_vol /* r1+0x10 */, struct PF_STR * p_path /* r1+0x14 */, unsigned long no_look_last_token /* r1+0x18 */);
